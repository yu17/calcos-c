...
int I2CClose(const uint8_t i2c_dev_fd){
...
// Not need since we have i2c-dev installed properly.
//int I2CReadByte(uint8_t i2c_dev_fd){
//	union i2c_smbus_data data;
//	if (ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_READ,0,I2C_SMBUS_BYTE,&data)) return -1;
//	else return data.byte & 0xFF;
//}
//
//int I2CReadRegByte(uint8_t i2c_dev_fd,uint8_t i2c_dev_reg){
//	union i2c_smbus_data data;
//	if (ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_READ,i2c_dev_reg,I2C_SMBUS_BYTE_DATA,&data)) return -1;
//	else return data.byte & 0xFF;
//}
//
//int I2CReadRegWord(uint8_t i2c_dev_fd,uint8_t i2c_dev_reg){
//	union i2c_smbus_data data;
//	if (ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_READ,i2c_dev_reg,I2C_SMBUS_WORD_DATA,&data)) return -1;
//	else return data.word & 0xFFFF;
//}
//
//int I2CWriteByte(uint8_t i2c_dev_fd,uint8_t value){
//	return ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_WRITE,value,I2C_SMBUS_BYTE,NULL);
//}
//
//int I2CWriteRegByte(uint8_t i2c_dev_fd,uint8_t reg,uint8_t value){
//	union i2c_smbus_data data;
//	data.byte = value;
//	return ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_WRITE,reg,I2C_SMBUS_BYTE_DATA,&data);
//}
//
//int I2CWriteRegWord(uint8_t i2c_dev_fd,uint8_t reg,uint8_t value){
//	union i2c_smbus_data data;
//	data.word = value;
//	return ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_WRITE,reg,I2C_SMBUS_WORD_DATA,&data);
//}
//
...
//	union i2c_smbus_data data;
//	data.word = value;
//	if (ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_WRITE,reg,I2C_SMBUS_PROC_CALL,&data)) return -1;
...
//	union i2c_smbus_data data;
//	if (ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_READ,reg,I2C_SMBUS_BLOCK_DATA,&data)) return -1;
//	else {
...
//	data.block[0] = length;
//	return ui2c_smbus_access(i2c_dev_fd,I2C_SMBUS_WRITE,reg,I2C_SMBUS_BLOCK_DATA,&data);
//}
